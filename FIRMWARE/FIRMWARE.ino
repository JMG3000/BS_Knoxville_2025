...
bool isOompaDead = true;              // Oompa Loompa status
...
void loop()
{
  ...
  else if (screenOn)
  {
    ...
    case 1:
      ...
      break;
    case 2:
      drawPageThree(BATTERY_READ);
      break;
    case 3:
      drawPageFour(scrollSpeed);
      break;
    case 4:
      drawPageFive(name);
      break;
...
void showBattery(uint8_t lvl, uint8_t color)
{
  ...
  {
  case 0:
    u8g2.drawXBM(9, 2, bat_width, bat_height, bat_0_bits);
    break;
  case 1:
    u8g2.drawXBM(9, 2, bat_width, bat_height, bat_25_bits);
    break;
  case 2:
    u8g2.drawXBM(9, 2, bat_width, bat_height, bat_50_bits);
    break;
  case 3:
    u8g2.drawXBM(9, 2, bat_width, bat_height, bat_75_bits);
    break;
  case 4:
    u8g2.drawXBM(9, 2, bat_width, bat_height, bat_100_bits);
    break;
  }
}
...
void showLogo(uint8_t img, uint8_t color)
{
  ...
  {
  case 0:
    u8g2.drawXBM(0, 1, bsk_logo_width, bsk_logo_height, bsk_logo_bits);
    break;
  default:
    u8g2.drawXBM(0, 1, fp_logo_width, fp_logo_height, fp_logo_bits);
  }
}
...
void setStatus(uint8_t stat, uint8_t lvl)
{
  ...
  {
  case 0:
    statusLED.setLedColorData(0, lvl, 0, 0);
    statusLED.show();
    break;
  case 1:
    statusLED.setLedColorData(0, lvl, lvl, 0);
    statusLED.show();
    break;
  case 2:
    statusLED.setLedColorData(0, lvl, lvl, lvl);
    statusLED.show();
    break;
  case 3:
    statusLED.setLedColorData(0, 0, lvl, 0);
    statusLED.show();
    break;
  case 4:
    statusLED.setLedColorData(0, 0, lvl, lvl);
    statusLED.show();
    break;
  case 5:
    statusLED.setLedColorData(0, 0, 0, lvl);
    statusLED.show();
    break;
  case 6:
    statusLED.setLedColorData(0, 0, lvl, 0);
    ...
    break;
  default:
    statusLED.setLedColorData(0, 0, 0, 0);
    statusLED.show();
  }
}
...
void showLevel(int x, int y, uint8_t lvl)
{
  ...
  {
  case 0:
    showBatterySmall(x, y, 0, 1);
    break;
  case 1:
    showBatterySmall(x, y, 1, 1);
    break;
  case 2:
    showBatterySmall(x, y, 2, 1);
    break;
  case 3:
    showBatterySmall(x, y, 3, 1);
    break;
  case 4:
    showBatterySmall(x, y, 4, 1);
    break;
  }
}
...
void showBatterySmall(int x, int y, uint8_t lvl, uint8_t color)
{
  ...
  {
  case 0:
    u8g2.drawXBM(x, y, bat_42x24_width, bat_42x24_height, bat_00_42x24_bits);
    break;
  case 1:
    u8g2.drawXBM(x, y, bat_42x24_width, bat_42x24_height, bat_25_42x24_bits);
    break;
  case 2:
    u8g2.drawXBM(x, y, bat_42x24_width, bat_42x24_height, bat_50_42x24_bits);
    break;
  case 3:
    u8g2.drawXBM(x, y, bat_42x24_width, bat_42x24_height, bat_75_42x24_bits);
    break;
  case 4:
    u8g2.drawXBM(x, y, bat_42x24_width, bat_42x24_height, bat_100_42x24_bits);
    break;
  }
}
...
void drawInfoBar(int y, uint8_t radio, uint8_t bat, char *time)
{
  ...
  {
  case 4:
    u8g2.drawStr(100, 1 + y, "\u0034");
    break;
  case 3:
    u8g2.drawStr(100, 1 + y, "\u0033");
    break;
  case 2:
    u8g2.drawStr(100, 1 + y, "\u0032");
    break;
  case 1:
    u8g2.drawStr(100, 1 + y, "\u0031");
    break;
  case 0:
    u8g2.drawStr(100, 1 + y, "\u0030");
    break;
  }
  if (radio)
  {
...
void serialHandler(void)
{
  ...
  while (Serial.available() > 0)
  {
    ...
    if (input != "\n")
    {
      ...
      if (input.substring(0, index) == "ssid")
      { // Handles [ssid] command
        preferences.begin("credentials", false);
      ...
      else if (input.substring(0, index) == "pw")
      { // Handles [password] command
        preferences.begin("credentials", false);
      ...
      else if (input.substring(0, index) == "reboot")
      { // Handles [reboot] command
        ESP.restart();
      }
      else if (input.substring(0, index) == "name")
      ...
      else if (input.substring(0, index) == "timeout")
      ...
      else if (input.substring(0, index) == "reset")
      ...
      else if (input.substring(0, index) == "timezone")
      ...
      else if (input.substring(0, index) == "debug")
      { // Handles [timezone] command
        preferences.begin("credentials", false);
      ...
      else if (input.substring(0, index) == "scroll")
      { // Handles [timezone] command
      ...
      else if (input.substring(0, index) == "cutoff")
      { // Handles [timezone] command
...
void drawPageThree(int rate)
{
  ...
  if ((new_time - batTime) >= rate)
  { // Update on cycle or screen change
    // Update Data
    raw_batVoltage = analogRead(BAT_SENSE);
    batVoltage = raw_batVoltage * voltageOffset;
    double pre = batVoltage / 3.7;
...
void drawPageFive(String name)
{
  ...
  do
  {
    ...
    if (strlen(name.c_str()) > 0)
    {
      ...
      int height = u8g2.getUTF8Hiegth(name.c_str());
      int x_pos = (128 - width) / 2;
      int y_pos = (128 - height) / 2;
      u8g2.setDrawColor(1);
      u8g2.drawStr(x_pos, 10, name.c_str());
      moveOompa(x, y); // test oompa
                       //      if(buttons == 0x10){
                       //        // move up
                       //      }
                       //      if(buttons == 0x20){
